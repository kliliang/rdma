...
/*#define SVC_MAX_SEND_WR 	16
#define SVC_MAX_SEND_SGE 	4
#define SVC_MAX_RECV_WR 	16
#define SVC_MAX_RECV_SGE 	4*/
/*#define SVC_MAX_SEND_WR 	4
#define SVC_MAX_SEND_SGE 	2
#define SVC_MAX_RECV_WR 	4
#define SVC_MAX_RECV_SGE 	2*/
...
alloc_conn(struct rdma_cm_id *cm_id,struct ibv_pd *pd,
				struct ibv_comp_channel *comp_chan,
				dw_bufpool_t *send_pool,dw_bufpool_t *recv_pool,dw_bufpool_t *longrpc_pool);
